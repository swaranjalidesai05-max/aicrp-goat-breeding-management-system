...
export const createDoeSchema = z.object({
...
export const updateDoeSchema = createDoeSchema.partial();

export const doeListQuerySchema = z.object({
...
export type CreateDoeInput = z.infer<typeof createDoeSchema>;
export type UpdateDoeInput = z.infer<typeof updateDoeSchema>;
