      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-stone-900">Bucks</h1>
          </div>
          <Link
            to="/"
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                ...
                <tbody>
                  {bucks.map((buck) => (
                    <tr key={buck.id} className="border-b border-stone-100">
                      <td className="px-3 py-2">{buck.tagNumber}</td>
                      <td className="px-3 py-2">{buck.name ?? '—'}</td>
                      <td className="px-3 py-2">{buck.cluster?.name ?? '—'}</td>
                      <td className="px-3 py-2">{buck.farmer?.fullName ?? '—'}</td>
                      <td className="px-3 py-2">{buck.status}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
